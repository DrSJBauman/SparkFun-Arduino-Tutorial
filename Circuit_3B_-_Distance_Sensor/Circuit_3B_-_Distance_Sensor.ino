...
void loop() {
  ...
  } else if(10 < distance && distance < 50){  //if the object is a medium distance
  ...
  } else if(50 < distance && distance < 100){                                     //if the object is far away
...
float getDistance()
{
  ...
  calculatedDistance = echoTime / 53.0;  //calculate the distance of the object that reflected the pulse (half the bounce time multiplied by the speed of sound)
